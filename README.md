...
- https://en.wikipedia.org/wiki/List_of_public_domain_projects
...
- https://docs.oracle.com/en/java/javase/26/security/general-security1.html
...
- https://corgi.rip/posts/pwntools-cheatsheet/ #Misc, Solve scripts
...
- [Containers](./privacy-selfhost/selfhost/containers)
    - https://www.stirling.com/
    - https://nextcloud.com/
    - https://www.canirun.ai/
- Mobile
    - Hardware
        - https://tools.techlore.tech/#mobile-hardware
        - https://wiki.volla.online/index.php?title=English
    - [Software:](https://github.com/4nuit/Hacking/tree/master/2fa_opsec#android)
        - https://f-droid.org/
...
Documents, notes, small programs and PoCs, mainly for my own personal learning.
See also [Writeups](https://github.com/4nuit/Writeup)
