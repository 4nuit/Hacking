...
A KDF derives a cryptographic key from external keying material such as a password or shared secret.
Many block ciphers expand the user-supplied secret key into a collection of internal round keys. The algorithm performing this expansion is called the key schedule. The round keys are internal values and are not generated by a Key Derivation
Function .
...
### Authenticated modes: CCM, OCB, GCM
