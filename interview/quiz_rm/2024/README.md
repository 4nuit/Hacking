...
**Bonus: code for questions 8, 9 and 12**
...
**Bonus: code for questions 6 and 8**
...
**Bonus: code for questions 2 and 9**
...
**Bonus: code for questions 7 and 12**

*Fuzz: single-level directory enumeration*
...
**Bonus: code for questions 2, 4 and 9**
...
**Bonus: code for questions 4, 6 and 10**
...
*CORS Regex Bypass (`.` instead of `\.`*
![q10](./images/quiz10_cors_regexp.png)

Possible to bypass the `.` with a DNS like: `flags2root-mi.org`
