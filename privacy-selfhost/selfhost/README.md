...
sudo mkdir -p /mnt/SSD/appdata/{qbittorrent,cross-seed,radarr,sonarr,prowlarr,jellyseerr,jellyfin,calibre-web-automated/ingest,shelfmark}
...
## client host: torrent/gluetun, port 5080 for *arr apps
...
## /data/media/{books,movies,music,tvshows} for *arr and media apps
```
