...
parser = argparse.ArgumentParser(prog='progname', usage='%(prog)s [func1] [func2]')
...
parser.add_argument('--func1', help='Usage func1')
parser.add_argument('--func2', help='Usage func2')
...
- https://realpython.com/ref/glossary/unpacking/

```py
def f(a,b):
    return a*b
    
def apply_args_to_f(f, packed_args):
    return f(*packed_args)
    
l = [apply_args_to_f(f, params) for params in [(1,2), (4, 3), (12, 42)]]
#l = [f(1,2), f(4,3), f(12, 42)]
```
