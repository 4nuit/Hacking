...
|            |  x86  | amd64 | arm |  mips    |
-----------------------------------------------
| ret val reg|  eax  | rax   | r0  |  ra      |
-----------------------------------------------
|   1st arg  |[eax+4]| rsi   | r0  |  a1      |
-----------------------------------------------
|   2nd arg  |[eax+8]| rdi   | r1  |  a2      |
-----------------------------------------------
|    call    |int0x80| call  | bl  | syscall  |
-----------------------------------------------
|  func ret  |  ret  | ret   | bxlr|  v0-v1   |
-----------------------------------------------
|  stack pt  |  esp  | rsp   | sp  |  sp      |
-----------------------------------------------
|  frame pt  |  ebp  | rbp   | fp  |  fp      |
-----------------------------------------------
|  mem load  |  mov  | mov   | ldr | li,lui,lw|
-----------------------------------------------
|  mem store |  mov  | mov  | str  | sb,sh,sw |
-----------------------------------------------
```
