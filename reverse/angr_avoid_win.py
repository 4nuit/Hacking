...
def main(argv):
  if (len(sys.argv) != 4):
    sys.exit("Usage ./angr_avoid_win.py <crackme> <addr_win> <addr_fail>")
  ...
  # space.
  # (!)
  print_good_address = int(argv[2], 0) # instruction which leads to "if (win)"
  will_not_succeed_address = int(argv[3],0)  # fail instruction
